                ...
                <div class="row">
                    ...
                    <div class="col-12">
                        <div class="card-box">
                            ...
                            <div class="col-3">
                                <div class="page-title-box d-flex" style="font-size: large">
                            ...
                            @if($user->contact_name)
                                <div class="col-3">
                                    <div class="page-title-box d-flex" style="font-size: large">
                                        <strong>Contact person's name: </strong> &nbsp; {{$user->contact_name}}
                                    </div>
                                </div>
                            @endif
                            ...
                            <div class="col-3">
                                <div class="page-title-box d-flex" style="font-size: large">
                                    <strong>Account type: </strong> &nbsp; @if($user->type == 0) Individual @else Company @endif
                                </div>
                            </div>

                            <div class="col-3">
                                <div class="page-title-box d-flex" style="font-size: large">
                                    <strong>User route: </strong> &nbsp; {{$user->mobile_user}}
                                </div>
                            </div>
